...
interface Optionals {
        ...
        void Register(int patientLimit1, int patientLimit2, int patientLimit3, int patientLimit4, int patientLimit5,
                        ...
                        String vaccinationSite1, String vaccinationSite2, String vaccinationSite3,
                        String vaccinationSite4,
                        String vaccinationSite5,
                        String vaccinator1, String vaccinator2, String vaccinator3, String vaccinator4,
                        String vaccinator5,
                        ...
                        LinkedHashMap<String, String> IDs1, LinkedHashMap<String, String> IDs2,
                        LinkedHashMap<String, String> IDs3,
        ...
        void CheckReservation(int patientLimit1, int patientLimit2, int patientLimit3, int patientLimit4,
                        int patientLimit5,
                        int attempts1, int attempts2, int attempts3, int attempts4, int attempts5,
                        String date1, String date2, String date3, String date4, String date5,
                        String vaccinationSite1, String vaccinationSite2, String vaccinationSite3,
        ...
        void EditReservation(int patientLimit1, int patientLimit2, int patientLimit3, int patientLimit4,
                        int patientLimit5,
                        int attempts1, int attempts2, int attempts3, int attempts4, int attempts5,
                        String date1, String date2, String date3, String date4, String date5,
                        String vaccinationSite1, String vaccinationSite2, String vaccinationSite3,
        ...
        void RemoveReservation(int patientLimit1, int patientLimit2, int patientLimit3, int patientLimit4,
                        int patientLimit5,
                        int attempts1, int attempts2, int attempts3, int attempts4, int attempts5,
                        String date1, String date2, String date3, String date4, String date5,
                        String vaccinationSite1, String vaccinationSite2, String vaccinationSite3,
        ...
        void forgotPassword(int patientLimit1, int patientLimit2, int patientLimit3, int patientLimit4,
                        int patientLimit5,
                        int attempts1, int attempts2, int attempts3, int attempts4, int attempts5,
                        String date1, String date2, String date3, String date4, String date5,
                        String vaccinationSite1, String vaccinationSite2, String vaccinationSite3,
        ...
        // ADMIN CAPABILITIES
        void SetReservation(int patientLimit1, int patientLimit2, int patientLimit3, int patientLimit4,
                        int patientLimit5,
                        int attempts1, int attempts2, int attempts3, int attempts4, int attempts5,
                        String date1, String date2, String date3, String date4, String date5,
                        String vaccinationSite1, String vaccinationSite2, String vaccinationSite3,
