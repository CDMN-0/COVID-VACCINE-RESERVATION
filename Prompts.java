...
public class Prompts {
    ...
    public static String getPassWord() {// Applying accessor for getting the value of name.
        // passWord = "1234";
        return passWord;// Returning the name afterwards.
    }
...

    {
        ...
        System.out.flush();
        if (setReserve == true) {
            System.out.println("\u001B[32mVaccinee is already saved on the reservation list.");
        }
        System.out.println(
                "\u001B[35m█████████████████████████████████████████████████████████████████████████████████████████████████████████▓▒░ COVID VACCINATION SYSTEM ░▒▓█████████████████████████████████████████████████████████████████████████████████████████████████████████\n");
        System.out.println("\u001B[36m\t\t\t\t\t\t\t\t\t\t\t\t\t\t    ▄▀▀▀▀▀▀▀▀▀▀▀▀▀▀█ █");
        System.out.println("\t\t\t\t\t\t\t\t\t\t\t\t\t    ▀▀▀▀▀▀▀▀▄─█─█─█─█─█─█──█▀█");
        System.out.println("\t\t\t\t\t\t\t\t\t\t\t\t\t\t     ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀ ▀\n");
        System.out.println("\t\t\t\t\t\t\t\t\t\t\t\t\t\t     DEVELOPED BY:");
        System.out.println("\t\t\t\t\t\t\t\t\t\t\t\t\t\t  Jeon Drew C. Jaime");
        System.out.println("\t\t\t\t\t\t\t\t\t\t\t\t\t\tCharles Daniel Nolasco");
        System.out.println("\t\t\t\t\t\t\t\t\t\t\t\t\t\tMarc Michael D. Malgapo");
        System.out.println("\t\t\t\t\t\t\t\t\t\t\t\t\t\t     Gian Dale Lim\n");
        System.out.println(
                "\u001B[35m██████████████████████████████████████████████████████████████████████████████████████████████████████████████████▓▒░ OPTIONS ░▒▓█████████████████████████████████████████████████████████████████████████████████████████████████████████████████\n");
        ...
        while (true) {
            try {
                ...
                if (choice == 1) {
                    System.out.print("\033[H\033[2J");
                    System.out.flush();
                    Admin(patientLimit1, patientLimit2, patientLimit3, patientLimit4, patientLimit5, attempts1,
                    ...
                    System.out.print("\033[H\033[2J");
                    System.out.flush();
                    User(patientLimit1, patientLimit2, patientLimit3, patientLimit4, patientLimit5, attempts1,
                            attempts2, attempts3, attempts4, attempts5, date1, date2, date3, date4, date5,
                            vaccinationSite1, vaccinationSite2, vaccinationSite3, vaccinationSite4, vaccinationSite5,
                            doctor1, doctor2, doctor3, doctor4, vaccinator5, doctor1, doctor2, doctor3, doctor4,
                            doctor5, start1, start2, start3, start4, start5, end1, end2, end3, end4, end5, input, imp,
                ...
                while (true) {
                    try {
                        ...
                        if (choice == 1) {
                            System.out.print("\033[H\033[2J");
                            System.out.flush();
                            imp.SetReservation(patientLimit1, patientLimit2, patientLimit3, patientLimit4,
                                    patientLimit5, attempts1, attempts2, attempts3, attempts4, attempts5, date1, date2,
                                    date3, date4, date5, vaccinationSite1, vaccinationSite2, vaccinationSite3,
                                    vaccinationSite4, vaccinationSite5, doctor1, doctor2, doctor3, doctor4, vaccinator5,
                                    doctor1, doctor2, doctor3, doctor4, doctor5, start1, start2, start3, start4, start5,
                                    end1, end2, end3, end4, end5, input, imp, nameList1, nameList2, nameList3,
                                    nameList4, nameList5, ageList1, ageList2, ageList3, ageList4, ageList5, mobileNum1,
                                    mobileNum2, mobileNum3, mobileNum4, mobileNum5, addresses1, addresses2, addresses3,
                                    addresses4, addresses5, IDs1, IDs2, IDs3, IDs4, IDs5, passList1, passList2,
                                    passList3, passList4, passList5, middleName1, middleName2, middleName3, middleName4,
                                    middleName5, timeList1, timeList2, timeList3, timeList4, timeList5, dateList1,
                                    dateList2, dateList3, dateList4, dateList5, doseName1, doseName2, doseName3,
                            ...
                            System.out.print("\033[H\033[2J");
                            System.out.flush();
                            imp.CheckReservation(patientLimit1, patientLimit2, patientLimit3, patientLimit4,
                                    patientLimit5, attempts1, attempts2, attempts3, attempts4, attempts5, date1, date2,
                                    date3, date4, date5, vaccinationSite1, vaccinationSite2, vaccinationSite3,
                                    vaccinationSite4, vaccinationSite5, doctor1, doctor2, doctor3, doctor4, vaccinator5,
                                    doctor1, doctor2, doctor3, doctor4, doctor5, start1, start2, start3, start4, start5,
                            ...
                            System.out.print("\033[H\033[2J");
                            System.out.flush();
                            imp.RemoveReservation(patientLimit1, patientLimit2, patientLimit3, patientLimit4,
                                    patientLimit5, attempts1, attempts2, attempts3, attempts4, attempts5, date1, date2,
                                    date3, date4, date5, vaccinationSite1, vaccinationSite2, vaccinationSite3,
                                    vaccinationSite4, vaccinationSite5, doctor1, doctor2, doctor3, doctor4, vaccinator5,
                                    doctor1, doctor2, doctor3, doctor4, doctor5, start1, start2, start3, start4, start5,
                                ...
                                try {
                                    ...
                                    if (pashpash.equals(getPassWord())) {
                                        ...
                                        while (true) {
                                            try {
                                                System.out
                                                        .print("\u001B[36mEnter 1 and press enter to exit: \u001B[0m");
                                                choice = input.nextInt();
                                                if (choice == 1) {
                                                    System.out.print("\033[H\033[2J");
                                                    System.out.flush();
                                                    ...
                                                    Prompts.Prompt(patientLimit1, patientLimit2, patientLimit3,
                                                            ...
                                                            vaccinationSite4, vaccinationSite5, doctor1, doctor2,
                                                            doctor3, doctor4, vaccinator5, doctor1, doctor2, doctor3,
                                                            doctor4, doctor5, start1, start2, start3, start4, start5,
                                                            end1, end2, end3, end4, end5, input, imp, nameList1,
                                                            ...
                                                            IDs3, IDs4, IDs5, passList1, passList2, passList3,
                                                            passList4, passList5, middleName1, middleName2, middleName3,
                                    ...
                                    System.out.println(
                                            "\u001B[31mInvalid input! Please enter a number and try again213123123.");
                                    input.nextLine();
                                    break;
                            ...
                            System.out.println(
                                    "\u001B[31mInvalid input! Please try agein and  enter a number from 1 to 7.");
                        }
                    } catch (InputMismatchException ex) {
                        System.out.println("\u001B[31mInvalid input! Please enter a number and try again.");
                        input.nextLine();
    ...
    public static void User(int patientLimit1, int patientLimit2, int patientLimit3, int patientLimit4,
            int patientLimit5,
            int attempts1, int attempts2, int attempts3, int attempts4, int attempts5,
            String date1, String date2, String date3, String date4, String date5,
            String vaccinationSite1, String vaccinationSite2, String vaccinationSite3, String vaccinationSite4,
        ...
        while (true) {
            try {
                ...
                if (choice == 1) {
                    System.out.print("\033[H\033[2J");
                    System.out.flush();
                    imp.Register(patientLimit1, patientLimit2, patientLimit3, patientLimit4, patientLimit5, attempts1,
                            attempts2, attempts3, attempts4, attempts5, date1, date2, date3, date4, date5,
                            vaccinationSite1, vaccinationSite2, vaccinationSite3, vaccinationSite4, vaccinationSite5,
                            doctor1, doctor2, doctor3, doctor4, vaccinator5, doctor1, doctor2, doctor3, doctor4,
                            doctor5, start1, start2, start3, start4, start5, end1, end2, end3, end4, end5, input, imp,
                    ...
                    System.out.print("\033[H\033[2J");
                    System.out.flush();
                    imp.CheckReservation(patientLimit1, patientLimit2, patientLimit3, patientLimit4, patientLimit5,
                            attempts1, attempts2, attempts3, attempts4, attempts5, date1, date2, date3, date4, date5,
                            vaccinationSite1, vaccinationSite2, vaccinationSite3, vaccinationSite4, vaccinationSite5,
                            doctor1, doctor2, doctor3, doctor4, vaccinator5, doctor1, doctor2, doctor3, doctor4,
                            doctor5, start1, start2, start3, start4, start5, end1, end2, end3, end4, end5, input, imp,
                            nameList1, nameList2, nameList3, nameList4, nameList5, ageList1, ageList2, ageList3,
                    ...
                    System.out.print("\033[H\033[2J");
                    System.out.flush();
                    imp.RemoveReservation(patientLimit1, patientLimit2, patientLimit3, patientLimit4, patientLimit5,
                            attempts1, attempts2, attempts3, attempts4, attempts5, date1, date2, date3, date4, date5,
                            vaccinationSite1, vaccinationSite2, vaccinationSite3, vaccinationSite4, vaccinationSite5,
                            doctor1, doctor2, doctor3, doctor4, vaccinator5, doctor1, doctor2, doctor3, doctor4,
                            doctor5, start1, start2, start3, start4, start5, end1, end2, end3, end4, end5, input, imp,
                    ...
                    imp.forgotPassword(patientLimit1, patientLimit2, patientLimit3, patientLimit4, patientLimit5,
                            attempts1, attempts2, attempts3, attempts4, attempts5, date1, date2, date3, date4, date5,
                            vaccinationSite1, vaccinationSite2, vaccinationSite3, vaccinationSite4, vaccinationSite5,
                            doctor1, doctor2, doctor3, doctor4, vaccinator5, doctor1, doctor2, doctor3, doctor4,
                            doctor5, start1, start2, start3, start4, start5, end1, end2, end3, end4, end5, input, imp,
